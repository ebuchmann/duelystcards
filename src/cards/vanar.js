const vanar = [
  { id: 20139, name: 'Flash Freeze', type: 'spell', cost: 0, rarity: 'core', faction: 'vanar', text: 'Deal 1 damage to a minion and <b>Stun</b> it.' },
  { id: 20150, name: 'Polarity', type: 'spell', cost: 0, rarity: 'common', faction: 'vanar', text: `Switch ANY minion's Attack and Health.` },
  { id: 20144, name: 'Aspect of the Fox', type: 'spell', cost: 1, rarity: 'core', faction: 'vanar', text: 'Transform ANY minion into a 3/3 Ravager with no abilities.' },
  { id: 20138, name: 'Mesmerize', type: 'spell', cost: 1, rarity: 'rare', faction: 'vanar', text: 'Teleport an enemy minion or General one space.' },
  { id: 510, name: 'Snow Chaser', type: 'vespyr', cost: 1, rarity: 'rare', attack: 2, health: 1, faction: 'vanar', text: '<b>Infiltrate</b>: When this minion dies, return it to your action bar.' },
  ...
  { id: 512, name: 'Borean Bear', type: 'vespyr', cost: 2, rarity: 'common', attack: 1, health: 3, faction: 'vanar', text: 'Whenever you summon a Vespyr minion, this minion gains +1 Attaack.' },
  ...
  { id: 531, name: 'Bur', type: 'battle pet', cost: 2, rarity: 'rare', attack: 3, health: 3, faction: 'vanar', text: 'When this minion survives damage, transform it into a different Battle Pet.' },
  { id: 20134, name: 'Chromatic Cold', type: 'spell', cost: 2, rarity: 'core', faction: 'vanar', text: 'Dispel a space. If there is an enemy minion or General on that space, deal it 2 damage.' },
  ...
  { id: 505, name: 'Crystal Cloaker', type: 'vespyr', cost: 2, rarity: 'core', attack: 2, health: 3, faction: 'vanar', text: '<b>Infiltrate</b>: Gains +2 Attack.' },
  ...
  { id: 20135, name: 'Frostfire', type: 'spell', cost: 2, rarity: 'core', faction: 'vanar', text: 'Give a friendly minion +3 Attack. If it is Vespyr, also give it +3 Health.' },
  ...
  { id: 530, name: 'Icy', type: 'battle pet', cost: 2, rarity: 'common', attack: 2, health: 3, faction: 'vanar', text: '<b>Opening Gambit</b>: Stun a nearby enemy minion or General.' },
  ...
  { id: 503, name: 'Fenrir Warmaster', type: 'minion', cost: 3, rarity: 'core', attack: 3, health: 2, faction: 'vanar', text: '<b>Dying Wish</b>: Summon a 3/2 Ghost Wolf on this space.' },
  { id: 519, name: 'Glacial Elemental', type: 'vespyr', cost: 3, rarity: 'rare', attack: 2, health: 3, faction: 'vanar', text: 'Whenever you summon a Vespyr minion, deal 2 damage to a random enemy minion.' },
  { id: 533, name: 'Iceblade Dryad', type: 'vespyr', cost: 3, rarity: 'epic', attack: 3, health: 3, faction: 'vanar', text: '<b>Opening Gambit</b>: Give a friendly Vespyr minion +1/+1 and <b>Flying</b>.' },
  { id: 529, name: 'Snow Rippler', type: 'vespyr', cost: 3, rarity: 'common', attack: 3, health: 4, faction: 'vanar', text: '<b>Infiltrate</b>: Whenever this minion damages a General, put a random Battle Pet into your action bar.' },
  { id: 30015, name: 'Snowpiercer', type: 'artifact', cost: 3, rarity: 'core', faction: 'vanar', text: 'Your General gains +3 Attack.' },
  ...
  { id: 20136, name: 'Avalanche', type: 'spell', cost: 4, rarity: 'core', faction: 'vanar', text: 'Deal 4 damage to ALL minions and Generals on your starting side of the battlefield and <b>Stun</b> them.' },
  ...
  { id: 526, name: 'Arctic Displacer', type: 'vespyr', cost: 5, rarity: 'core', attack: 10, health: 4, faction: 'vanar', text: '<b>Airdrop</b>' },
  ...
  { id: 133742, name: 'Draugar Lord', type: 'vespyr', cost: 6, rarity: 'epic', attack: 4, health: 8, faction: 'vanar', text: '<b>Dying Wish</b>: Summon a 4/8 Ice Drake on this space.' },
  { id: 514, name: 'Ancient Grove', type: 'vespyr', cost: 7, rarity: 'legendary', attack: 7, health: 7, faction: 'vanar', text: '<b>Provoke</b><br> <b>Opening Gambit</b>: You rminions gain "<b>Dying Wish</b>: Summon a 1/1 Treant with <b>Provoke</b>."' },
