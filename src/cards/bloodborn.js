const bloodborn = [
  ...
  { id: null, name: 'Horror Burster', set: 'bloodborn', type: 'spell', cost: 3, rarity: 'rare', attack: 4, health: 1, faction: 'abyssian', text: '<b>Dying Wish:</b> Transform a random friendly minion into a 6/6 Horror.' },
