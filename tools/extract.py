...
# Usage is something like `py extract <path to sprite file>`
# not the png file, but the other file along with the images
# then it creates a folder of images so each frame is separated
