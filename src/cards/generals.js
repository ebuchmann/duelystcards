const generals = [
  { id: 1, name: 'Argeon Highmayne', type: 'general', faction: 'lyonar', attack: 2, health: 25, text: '<b>Bloodborn Spell:</b> Give a minon nearby your General +2 Attack.' },
  { id: 23, name: `Zir'An Sunforge`, type: 'general', faction: 'lyonar', attack: 2, health: 25, text: '<b>Bloodborn Spell:</b> Restore 3 Health to any minion.' },
  { id: 101, name: 'Kaleos Xaan', type: 'general', faction: 'songhai', attack: 2, health: 25, text: '<b>Bloodborn Spell:</b> Teleport a friendly minion up to 2 spaces.' },
  { id: 123, name: 'Reva Eventide', type: 'general', faction: 'songhai', attack: 2, health: 25, text: '<b>Bloodborn Spell:</b> Summon a Heartseeker nearby your General.' },
