const lyonar = [
  ...
  { id: 14, name: 'Silverguard Squire', type: 'minion', cost: 1, rarity: 'common', faction: 'lyonar', text: '' },
  { id: 20043, name: 'Sundrop Elixir', type: 'spell', cost: 1, rarity: 'common', faction: 'lyonar', text: 'Restore 5 Health to a minion or General.' },
  { id: 233713, name: 'True Strike', type: 'spell', cost: 1, rarity: 'core', faction: 'lyonar', text: 'Deal 2 damage to a minion.' },
  { id: 21, name: 'Azurite Lion', type: 'minion', cost: 2, rarity: 'common', faction: 'lyonar', text: '<b>Celerity</b>' },
  { id: 25, name: 'Fiz', type: 'battle pet', cost: 2, rarity: 'rare', faction: 'lyonar', text: '<b>Opening Gambit</b>: Restore 2 Health to a minion or General.' },
  ...
  { id: 20044, name: 'Tempest', type: 'spell', cost: 2, rarity: 'core', faction: 'lyonar', text: 'Deal 2 damage to ALL minions and Generals.' },
  { id: 20047, name: 'War Surge', type: 'spell', cost: 2, rarity: 'core', faction: 'lyonar', text: 'Give all friendly minions +1/+1' },
  { id: 9, name: 'Windblade Adept', type: 'minon', cost: 2, rarity: 'core', attack: 2, health: 3, faction: 'lyonar', text: '<b>Zeal</b>: Gain +2 Attack.' },
  ...
  { id: 20068, name: 'Divine Bond', type: 'spell', cost: 3, rarity: 'core', faction: 'lyonar', text: 'Give a minion +Attack equal to its Health.' },
  { id: 20090, name: 'Martyrdom', type: 'spell', cost: 3, rarity: 'core', faction: 'lyonar', text: `Destroy ANY minion. Restore that minion's Health to its General` },
  ...
  { id: 11, name: 'Silverguard Knight', type: 'minion', cost: 3, rarity: 'core', attack: 1, health: 5, faction: 'lyonar', text: '<b>Provoke</b><br> <b>Zeal</b>: Grains +2 Attack.' },
  ...
  { id: 8, name: 'Lysian Brawler', type: 'minion', cost: 4, rarity: 'core', attack: 4, health: 4, faction: 'lyonar', text: '<b>Celerity</b>' },
